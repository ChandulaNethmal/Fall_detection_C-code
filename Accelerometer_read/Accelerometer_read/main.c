 ...
 * Delevery Drone
 *chandula-nethmal
 * MPU6050 I2C read and Parachute ejector 
 * ATmega328p 
 *
 */ 
...
int main()
{
	...
	uart_init();									/* Initialize USART with 9600 baud rate */
	stdout = &uart_output;
	...
	while(1)
	{
		...
		Xa = (Acc_x-0)/-944;								/* Divide raw value by sensitivity scale factor to get real values */
		Ya = (Acc_y-77)/-944;
		Za = (Acc_z+2200)/956;
